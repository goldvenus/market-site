        ...
        <AuthSideMenu />
        {
          this.state.isConfirmed ? (
            ...
            <div className="login success-message">
              <h1>Confirm</h1>
              {
                this.email ? null : (
                  ...
                  <div className='verification-code'>
                    <CustomInput placeholder='Email' type="text" required="required" value={this.state.email} onChange={(value) => this.setState({ email: value })}/>
                  </div>
                  </div>
                )
              }
              ...
              <div className='verification-code'>
                <CustomInput placeholder='Verification Code' type="text" required="required" value={this.state.code} onChange={(value) => this.setState({ code: value })}/>
              </div>
