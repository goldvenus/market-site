...
function DownshiftMultiple(props) {
  const { classes, floatingLabel, handleGearChange, handleGearDelete, initialSelectedItem } = props;
...
const useStyles = () => ({
  ...
  paper: "position: 'absolute', zIndex: 1, marginTop: 130, left: 0, right: 0",
  chip: "margin: 130",
  inputRoot: "flexWrap",
  inputInput: "width: 'auto', flexGrow: 10",
  divider: "height: 10"
});

// let popperNode;

const CustomAutoComplete = ({gears, floatingLabel, handleGearChange, handleGearDelete, initialSelectedItem}) => {
  ...
  return (
    <div className={classes.root}>
      ...
      <DownshiftMultiple
        ...
        handleGearDelete={handleGearDelete}
