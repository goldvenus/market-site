      ...
      <div className="auth-container theme-navbar">
        <AuthSideMenu />
        {
          ...
          <div className="login success-message">
            ...
            <button className="theme-btn theme-btn-primary theme-btn-submit theme-btn-link"><Link to="/login">Sign In</Link></button>
          </div>): (
            <div className="login">
              <h1>Forgot Password?</h1>
              <div className="login-or-divider">Enter your email, the instruction will be sent for password recovery</div>
              ...
              <div className="flex-row">
                ...
                <button className="theme-btn theme-btn-filled-white theme-btn-link"><Link to="/login">Sign In <span className="fa fa-angle-right" /></Link></button>
              </div>
            </div>
          )
        }
