          ...
          <div className="payment-body">
            <div className="container flex-row flex-align-stretch ">
                ...
                <div className="theme-form address-info-wrapper">
                  ...
                  <div className="theme-form-field save-addr-btn">
                    <div className="input_svg pretty p-svg p-plain">
                      <input type="checkbox" onChange={this.handleSetSaveState} value={saveAddr}
                             checked={saveAddr ? 'checked' : ''}/>
                      <div className="state">
              ...
              <div className="order-info">
                <div className="order-info-header">
                  ...
                  <button className="theme-btn theme-btn-filled-white theme-btn-link btn-edit-order"><Link to="/cart">Edit
                    Order</Link>
                  </button>
                </div>
                <div className='order-info-body'>
                  ...
                  <div className="checkout-amount">
                    <div><span className="text-gray">Amount </span> <b
                      className='checkout-total-price'>${parseFloat(amount).toFixed(2)}</b></div>
                  </div>
                </div>
              </div>
            </div>
            <div className="container flex-row flex-align-stretch ">
              <div className="flex-row bottom-buttons">
                <button className="theme-btn theme-btn-secondery btn-edit-order-bottom"><Link to="/cart">Back to
                  Cart</Link></button>
