 export const data = {
  faqs: [
    ...
    },
    {
      ...
      content: 'To rent gear, you simply head over to “RENT GEAR”, and search for what you’re looking for. Once you find it, select your rental period and add the gear to your cart. After you proceed to checkout, we will ask you to create a project name, in case you might be renting more than one item from more than one owner at once. After that, we will require a full payment, which will be securely held in escrow and only released to the gear owner once both parties have confirmed that the gear has been picked up.'
    },
    {
      title: 'How do I list my own gear for rent?',
      content: 'To list your own gear for rent, you simply head over to the “ADD GEAR” page and fill in all the required information. We kindly ask gear owners to use real photos of their own gear, rather than photos of similar gear found online. After completing all the steps, your gear should instantly be live and available for rent on Creative Market. And remember, you can always head over to “MY GEAR” if you want to edit or remove gear.'
    },{
      title: 'How do renters and owner communicate?',
      content: 'Once a rental has been confirmed by the renter’s payment, a conversation will automatically open up within “MESSAGES”. This allows both parties to easily communicate throughout the entire rental period. For safety and legal reason, we insist that all members follow our terms of use and exclusively communicate through the Creative Market platform during the rental period.'
    },{
      title: 'Where do renters pickup and return gear?',
      content: 'As long as gear pickup and return take place during the agreed rental period, specific time and location details are entirely up to you. Renters and Owners can easily coordinate on these matters within “MESSAGES”. If both parties fail to agree on a pickup time/location, rentals can be canceled and a full refund issued to the renter within 48 hours.'
    },{
      ...
      content: 'Creative Market solely serves as a limited agent and offers a platform through which the renters and owners can digitally communicate and execute Gear rentals. As stated in the “TERMS OF USE”, both renters and owners agree and acknowledge that Creative Market is not offering or inspecting any gear that you rent through our platform. Therefore cannot make any warranties and representations about the quality and safety of the gear. All legal claims in relation to the renting of gear must be brought directly against the other party. We always recommend to first contact the other party through “MESSAGES” and make an attempt to resolve the dispute amicably.'
    },{
