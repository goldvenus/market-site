      ...
      <div>
        <Row className="my-listing my-listing-tabs gear-history-top-panel">
          <Col sm="24" className="listing-body calendar_all_parent">
            <div className="d-flex align-items-center">
              ...
              <button className="theme-btn theme-btn-primary ml-auto mb-3">Add Gear</button>
            </div>
        ...
        </Row>
        {
          this.state.modal_open_st === 2 ?
            <GearEditModal gearid={this.state.cur_gear} onClose={this.handleClose}/> :
          this.state.modal_open_st === 1 ?
            <RentalCalendarModal onClose={this.handleClose}/> : null
        }
      </div>
    )
  }
